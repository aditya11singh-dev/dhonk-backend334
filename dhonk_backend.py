...
OPENROUTER_API_KEY = "your_api_key_here"   # ⚠️ SECURITY: env var me rakho
OPENROUTER_BASE_URL = "https://openrouter.ai/api/v1/chat/completions"
MODEL_NAME = "mistralai/mistral-7b-instruct"

# 🛢️ PostgreSQL Database Config
DB_CONFIG = {
    "host": "localhost",       # ⚠️ Render pe env var use karna
...
if __name__ == "__main__":
    ...
    app.run(host="0.0.0.0", port=5000)   # ⚠️ Render expects host=0.0.0.0
